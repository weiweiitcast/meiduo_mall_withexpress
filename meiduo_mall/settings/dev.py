...
INSTALLED_APPS = [
    ...
    'MeiduoExpress.apps.MeiduoexpressConfig',
]
...
CACHES = {
    "default": {  # 默认
        ...
        "LOCATION": "redis://192.168.203.140:6379/0",  # 可改：ip、port、db
        "OPTIONS": {
    ...
    "session": {  # session
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": "redis://192.168.203.140:6379/1",
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        }
    },
    "image_code": {  # 图形验证码
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": "redis://192.168.203.140:6379/2",
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        }
    },
    "sms_code": {  # 短信验证码
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": "redis://192.168.203.140:6379/3",
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        }
    },
    "history": {  # 浏览记录
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": "redis://192.168.203.140:6379/4",
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        }
    },
    "cart": {  # 购物车
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": "redis://192.168.203.140:6379/5",
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        }
    },
...
JWT_AUTH = {
    'JWT_EXPIRATION_DELTA': timedelta(days=100), # 有效期为1天
...
BROKER_URL= 'redis://192.168.203.140:6379/0'
CELERY_RESULT_BACKEND = 'redis://192.168.203.140:6379/0'
CELERY_IMPORTS = ('MeiduoExpress.tasks', )