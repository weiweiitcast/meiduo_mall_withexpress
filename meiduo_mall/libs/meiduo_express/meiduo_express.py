from .kdniao_express.request_type import *
from .kdniao_express.kdniao_express import KDNiaoExpress
from .kdniao_express.request_urls import *

class MeiduoExpress(KDNiaoExpress):
